        ...
        <section className='documents__section'>
          <article className='documents__section__article'>
            ...
            <footer className='documents__section__article__footer'>
              <button><i class="fa fa-file-pdf-o" aria-hidden="true"></i>VER</button>
            </footer>
          </article>
          ...
          <article className='documents__section__article'>
            ...
            <footer className='documents__section__article__footer'>
              <button><i class="fa fa-external-link" aria-hidden="true"></i>ACCEDER</button>
            </footer>
          </article>
          ...
          <article className='documents__section__article'>
            ...
            <footer className='documents__section__article__footer'>
              <button><i class="fa fa-file-pdf-o" aria-hidden="true"></i> ABRIR</button>
            </footer>
          </article>
